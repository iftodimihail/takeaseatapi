...
var _rating_types = require('../repositories/rating_types');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return (0, _rating_types2.default)(db).index();

            case 3:
              ratingTypess = _context.sent;
              return _context.abrupt('return', (0, _response2.default)(res).collection(ratingTypess, _filter_types2.default));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return (0, _rating_types2.default)(db).show(req.params.id);

            case 3:
              ratingTypes = _context2.sent;
              return _context2.abrupt('return', (0, _response2.default)(res).item(ratingTypes, _filter_types2.default));
...
//# sourceMappingURL=rating_types.js.map