...
var _kitchen_types = require('../models/kitchen_types');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return (0, _kitchen_types2.default)(db).find().toArray();
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              body.updated_at = now;
              _context2.next = 6;
              return (0, _kitchen_types2.default)(db).insertOne(body);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return (0, _kitchen_types2.default)(db).findOne({ _id: mongoDB.ObjectId(id) });
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              body.updated_at = now;
              _context4.next = 6;
              return (0, _kitchen_types2.default)(db).findOneAndUpdate({ _id: mongoDB.ObjectId(id) }, body);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.prev = 0;
              _context5.next = 3;
              return (0, _kitchen_types2.default)(db).findOneAndDelete({ _id: mongoDB.ObjectId(id) });
