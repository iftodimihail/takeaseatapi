...
var _localuri = require('../models/localuri');
...
exports.default = function (db) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return (0, _localuri2.default)(db).find().toArray();
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              body.updated_at = now;
              _context2.next = 6;
              return (0, _localuri2.default)(db).insertOne(body);
  ...
  var show = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(uniqueLink) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return (0, _localuri2.default)(db).findOne({ uniqueLink: uniqueLink });
